...
Nordavind = WindRegion("Nordavind", OFFSHORE_FAILURE_MULTIPLIER, 0.494, 200)
Nordvest = WindRegion("Nordvest", OFFSHORE_FAILURE_MULTIPLIER, 0.483, 110)
Vestavind1 = WindRegion("Vestavind1", OFFSHORE_FAILURE_MULTIPLIER, 0.489, 70)
Vestavind2 = WindRegion("Vestavind2", OFFSHORE_FAILURE_MULTIPLIER, 0.512, 50)
SorvestA = WindRegion("SorvestA", OFFSHORE_FAILURE_MULTIPLIER, 0.545, 122)
SorvestB = WindRegion("SorvestB", OFFSHORE_FAILURE_MULTIPLIER, 0.543, 152)
SorvestC = WindRegion("SorvestC", OFFSHORE_FAILURE_MULTIPLIER, 0.551, 153)
SorvestD = WindRegion("SorvestD", OFFSHORE_FAILURE_MULTIPLIER, 0.545, 221)
SorvestE = WindRegion("SorvestE", OFFSHORE_FAILURE_MULTIPLIER, 0.561, 112)
SorvestF = WindRegion("SorvestF", OFFSHORE_FAILURE_MULTIPLIER, 0.559, 152)
Sonnavind = WindRegion("Sonnavind", OFFSHORE_FAILURE_MULTIPLIER, 0.565, 60)
